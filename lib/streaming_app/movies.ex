defmodule StreamingApp.Movies do
  @moduledoc """
  The Movies context.
  """
  ...
  """
  def list_movies do
    Repo.all(Movie) |>Repo.preload(:streamer) |>Repo.preload(:actors)
  end
  ...
  """
  def get_movie!(id), do: Repo.get!(Movie, id) |>Repo.preload(:streamer) |>Repo.preload(:actors)
